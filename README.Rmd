...
Then to install this package use the code `remotes::install_github("ailich/GLCMTextures")` (you may need to install Rtools using the instructions found [here](https://cran.r-project.org/bin/windows/Rtools/))
